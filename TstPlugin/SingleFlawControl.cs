...
namespace PxP
{
    public partial class SingleFlawControl : UserControl
    {
        ...
        private void tabFlawControl_DoubleClick(object sender, EventArgs e)
        {
            ...
            PxPTab PxPTabController = new PxPTab();
            PxPTabController.Name = "PxPTabController";
            int p = Convert.ToInt32(this.Tag) / PxPVariable.PageSize + 1;
            PxPVariable.PageCurrent = p;
            PxPVariable.ChooseFlawID = Convert.ToInt32(this.Tag);
            PxPTabController.DrawTablePictures(MapWindowVariable.FlawPieces, MapWindowVariable.CurrentPiece, p);
