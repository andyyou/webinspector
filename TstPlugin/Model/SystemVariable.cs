...
namespace PxP
{
    public class SystemVariable
    {
        ...
        public SystemVariable() {
            //Debug
            DebugTool.WriteLog("SystemVariable.cs", "SystemVariable()");
        }
        ...
        {
            //Debug
            DebugTool.WriteLog("SystemVariable.cs", "GetSysConfXDoc()");
        ...
        {
            //Debug
            DebugTool.WriteLog("SystemVariable.cs", "GetConfig()");
        ...
        {
            //Debug
            DebugTool.WriteLog("SystemVariable.cs", "GetGradeConfXDoc() # 取得 grade conf 參數檔");
        ...
        internal static void LoadSystemConfig()
        {
            ...
            //Debug
            DebugTool.WriteLog("SystemVariable.cs", " LoadSystemConfig() # 載入/sys_conf/sys.xml");
            ...
            {
                DebugTool.WriteLog("SystemVariable.cs", "*** Load System Config Error:" + ex.Message);
            }

            //Debug
            DebugTool.WriteLog("SystemVariable.cs", " LoadSystemConfig() # 載入/sys_conf/sys.xml 完畢");
        }
